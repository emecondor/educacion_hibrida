...
***************************************************************************************************************
			...
			label variable  TOTAL_BAJADA "Mpbs Bajada"
			label variable  TOTAL_SUBIDA "Mpbs Subida"
			...
			label variable Mpbs_total_rango "Rango - Total Mpbs actualmente en la escuela"
